...
import CopyIcon from '../copy-markdown.png'
...
interface CopyMarkdownButtonState {
  showTooltip: boolean
}

const CopyMarkdownButton = (props: CopyMarkdownButtonProps) => {
  const [state, setState] = useState<CopyMarkdownButtonState>({showTooltip: false})
  if (props.tooltip) {
